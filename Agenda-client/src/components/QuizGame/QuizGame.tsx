  ...
  return (
    <>
      ...
      {!quizData && !isLoading && (
        <button
          onClick={loadQuiz}
          className="bg-[#ff7b10] mt-20 text-white font-bold py-2 px-4 rounded-full hover:bg-orange-600 focus:outline-none focus:shadow-outline text-center mx-auto block"
        >
          Load Quiz
        </button>
      )}
